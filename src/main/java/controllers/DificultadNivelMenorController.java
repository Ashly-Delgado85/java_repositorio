 ...
 * @author Ashly
 */
public class DificultadNivelMenorController implements Initializable {

    @FXML
    private Button btnIniciarTiempo;
    @FXML
    private Label labelTiempo; //se muestra el tiempo
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     private int tiempoRestante = 120; //tiempo inical
    ...
    @FXML
    private void btnIniciarTiempoClick(ActionEvent event) {
        iniciarCronometro();
    }
}
